public class TelcoSubscription implements Telco{
    private String telcoName;
    private double promoPrice;
    private int dataAllowance;    
    private boolean unliCallText;

    public TelcoSubscription(int dataAllowance, double promoPrice, String telcoName, boolean unliCallText){
    ...
    // Getters and Setters
    public void setDataAllowance(int dataAllowance){ this.dataAllowance = dataAllowance; }
    ...
    public void setTelcoName(String telcoName){this.telcoName = telcoName;}
    public String getTelcoName(){return telcoName;}
    public void setUnliCallText(boolean unliCallText){this.unliCallText = unliCallText;}
